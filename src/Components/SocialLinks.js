...
export default function SocialLinks(){
    ...
    return(
        <div className="Social-container">
            ...
            <div className="Social-row"> 
               <a href="https://soundcloud.com/jordyevanz/tracks" target="_blank" rel="noreferrer"><img src={process.env.PUBLIC_URL + '/Images/soundcloud.svg'} alt={'soundcloud'} height="40vh" /></a> 
            </div>
            {/* <div className="Social-row">
